...
#[test]
pub fn test_rocks_log_rocks_state_store() {
  TypeConfig::run(async {
    Suite::test_all(RocksLogRocksStateBuilder {}).await.unwrap();
  });
}
