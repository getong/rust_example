...
use deno_cache_dir::{
  file_fetcher::{
    AuthTokens, CacheSetting, FetchLocalOptions, FetchNoFollowErrorKind, FetchNoFollowOptions,
    FileFetcher, FileFetcherOptions, FileOrRedirect, HttpClient, NullBlobStore, NullMemoryFiles,
    SendError, SendResponse,
  },
  memory::MemoryHttpCache,
};
use http::HeaderMap;
...
// copy from https://github.com/denoland/deno_cache_dir/blob/main/rs_lib/tests/file_fetcher_test.rs
