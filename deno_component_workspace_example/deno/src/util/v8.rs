...
pub fn init_v8_flags(default_v8_flags: &[String], v8_flags: &[String], env_v8_flags: Vec<String>) {
  if default_v8_flags.is_empty() && v8_flags.is_empty() && env_v8_flags.is_empty() {
    return;
  }
