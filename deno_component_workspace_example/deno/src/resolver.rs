...
pub type CliCjsTracker = deno_resolver::cjs::CjsTracker<DenoInNpmPackageChecker, CliSys>;
pub type CliIsCjsResolver = deno_resolver::cjs::IsCjsResolver<DenoInNpmPackageChecker, CliSys>;
