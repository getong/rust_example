...
use deno_ast::{swc::common::Span, view::TruePlusMinus};

use super::buffer::{AstBufSerializer, CommentKind, NodeRef, SerializeCtx};
...
impl TsEsTreeBuilder {
  ...
  pub fn write_import_attr(&mut self, span: &Span, key: NodeRef, value: NodeRef) -> NodeRef {
  ...
  pub fn write_import_default_spec(&mut self, span: &Span, local: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::ImportDefaultSpecifier, span);
    self.ctx.write_ref(AstProp::Local, &id, local);
    self.ctx.commit_node(id)
  }

  pub fn write_import_ns_spec(&mut self, span: &Span, local: NodeRef) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_export_ts_namespace(&mut self, span: &Span, ident: NodeRef) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_ts_external_mod_ref(&mut self, span: &Span, expr: NodeRef) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_class_expr(
    ...
    self
      .ctx
      .write_maybe_undef_ref(AstProp::SuperTypeArguments, &id, super_type_args);
    self
      .ctx
  ...
  pub fn write_class_body(&mut self, span: &Span, body: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_block_stmt(&mut self, span: &Span, body: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_with_stmt(&mut self, span: &Span, obj: NodeRef, body: NodeRef) -> NodeRef {
  ...
  pub fn write_return_stmt(&mut self, span: &Span, arg: Option<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::ReturnStatement, span);
    self.ctx.write_maybe_ref(AstProp::Argument, &id, arg);
    self.ctx.commit_node(id)
  }

  pub fn write_labeled_stmt(&mut self, span: &Span, label: NodeRef, body: NodeRef) -> NodeRef {
  ...
  pub fn write_break_stmt(&mut self, span: &Span, label: Option<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::BreakStatement, span);
    self.ctx.write_maybe_ref(AstProp::Label, &id, label);
    self.ctx.commit_node(id)
  }

  pub fn write_continue_stmt(&mut self, span: &Span, label: Option<NodeRef>) -> NodeRef {
  ...
  pub fn write_while_stmt(&mut self, span: &Span, test: NodeRef, body: NodeRef) -> NodeRef {
  ...
  pub fn write_do_while_stmt(&mut self, span: &Span, test: NodeRef, body: NodeRef) -> NodeRef {
  ...
  pub fn write_arr_expr(&mut self, span: &Span, elems: Vec<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::ArrayExpression, span);
    self.ctx.write_ref_vec(AstProp::Elements, &id, elems);
    self.ctx.commit_node(id)
  }

  pub fn write_obj_expr(&mut self, span: &Span, props: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_unary_expr(&mut self, span: &Span, operator: &str, arg: NodeRef) -> NodeRef {
  ...
  pub fn write_sequence_expr(&mut self, span: &Span, exprs: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_yield_expr(&mut self, span: &Span, delegate: bool, arg: Option<NodeRef>) -> NodeRef {
  ...
  pub fn write_meta_prop(&mut self, span: &Span, meta: NodeRef, prop: NodeRef) -> NodeRef {
  ...
  pub fn write_identifier(
    ...
    self
      .ctx
      .write_maybe_undef_ref(AstProp::TypeAnnotation, &id, type_annotation);
    self
      .ctx
  ...
  pub fn write_private_identifier(&mut self, span: &Span, name: &str) -> NodeRef {
  ...
  pub fn write_str_lit(&mut self, span: &Span, value: &str, raw: &str) -> NodeRef {
  ...
  pub fn write_num_lit(&mut self, span: &Span, value: &str, raw: &str) -> NodeRef {
    let id = self.ctx.append_node(AstNode::Literal, span);
  ...
  pub fn write_jsx_attr(&mut self, span: &Span, name: NodeRef, value: Option<NodeRef>) -> NodeRef {
  ...
  pub fn write_jsx_spread_attr(&mut self, span: &Span, arg: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::JSXSpreadAttribute, span);
    self.ctx.write_ref(AstProp::Argument, &id, arg);
    self.ctx.commit_node(id)
  }

  pub fn write_jsx_closing_elem(&mut self, span: &Span, name: NodeRef) -> NodeRef {
  ...
  pub fn write_jsx_expr_container(&mut self, span: &Span, expr: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::JSXExpressionContainer, span);
    self.ctx.write_ref(AstProp::Expression, &id, expr);
    self.ctx.commit_node(id)
  }

  pub fn write_jsx_text(&mut self, span: &Span, raw: &str, value: &str) -> NodeRef {
  ...
  pub fn write_jsx_member_expr(&mut self, span: &Span, obj: NodeRef, prop: NodeRef) -> NodeRef {
  ...
  pub fn write_ts_module_block(&mut self, span: &Span, body: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_ts_enum_body(&mut self, span: &Span, members: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_ts_type_param_inst(&mut self, span: &Span, params: Vec<NodeRef>) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_ts_inst_expr(&mut self, span: &Span, expr: NodeRef, type_arg: NodeRef) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_ts_as_expr(&mut self, span: &Span, expr: NodeRef, type_ann: NodeRef) -> NodeRef {
  ...
  pub fn write_ts_interface_body(&mut self, span: &Span, body: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_ts_setter_sig(&mut self, span: &Span, key: NodeRef, param: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSMethodSignature, span);
  ...
  pub fn write_ts_union_type(&mut self, span: &Span, types: Vec<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSUnionType, span);
    self.ctx.write_ref_vec(AstProp::Types, &id, types);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_intersection_type(&mut self, span: &Span, types: Vec<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSIntersectionType, span);
    self.ctx.write_ref_vec(AstProp::Types, &id, types);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_infer_type(&mut self, span: &Span, type_param: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSInferType, span);
    self.ctx.write_ref(AstProp::TypeParameter, &id, type_param);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_type_op(&mut self, span: &Span, op: &str, type_ann: NodeRef) -> NodeRef {
  ...
  pub fn write_ts_keyword(&mut self, kind: TsKeywordKind, span: &Span) -> NodeRef {
    let kind = match kind {
  ...
  pub fn write_ts_rest_type(&mut self, span: &Span, type_ann: NodeRef) -> NodeRef {
  ...
  pub fn write_ts_type_lit(&mut self, span: &Span, members: Vec<NodeRef>) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSTypeLiteral, span);
    self.ctx.write_ref_vec(AstProp::Members, &id, members);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_optional_type(&mut self, span: &Span, type_ann: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSOptionalType, span);
    self.ctx.write_ref(AstProp::TypeAnnotation, &id, type_ann);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_type_ann(&mut self, span: &Span, type_ann: NodeRef) -> NodeRef {
    let id = self.ctx.append_node(AstNode::TSTypeAnnotation, span);
    self.ctx.write_ref(AstProp::TypeAnnotation, &id, type_ann);
    self.ctx.commit_node(id)
  }

  pub fn write_ts_array_type(&mut self, span: &Span, elem_type: NodeRef) -> NodeRef {
  ...
  pub fn write_ts_tuple_type(&mut self, span: &Span, elem_types: Vec<NodeRef>) -> NodeRef {
  ...
  pub fn write_ts_type_param_decl(&mut self, span: &Span, params: Vec<NodeRef>) -> NodeRef {
    let id = self
      .ctx
  ...
  pub fn write_ts_qualified_name(&mut self, span: &Span, left: NodeRef, right: NodeRef) -> NodeRef {
  ...
  fn write_plus_minus_true(&mut self, prop: AstProp, value: Option<TruePlusMinus>) {
    match value {
