...
use super::{
  diagnostics::PublishDiagnosticsCollector, module_content::ModuleContentProvider,
...
pub fn create_gzipped_tarball(
  ...
  for path in publish_paths {
    ...
    tar
      ...
      .with_context(|| format!("Unable to add file to tarball '{}'", path.path.display()))?;
  }
...
impl TarGzArchive {
  ...
  pub fn add_file(&mut self, path: String, data: &[u8]) -> Result<(), AnyError> {
