...
impl CliOptions {
  ...
  pub fn resolve_inspector_server(&self) -> Result<Option<InspectorServer>, AnyError> {
  ...
  pub fn newest_dependency_date(&self) -> Option<chrono::DateTime<chrono::Utc>> {
...
#[cfg(test)]
mod test {
  use deno_config::deno_json::{AllowDenyPermissionConfig, PermissionsObject};
