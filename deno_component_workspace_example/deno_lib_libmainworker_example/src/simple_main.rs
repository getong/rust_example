...
use deno_resolver::npm::{
  CreateInNpmPkgCheckerOptions, DenoInNpmPackageChecker, NpmResolver, NpmResolverCreateOptions,
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
  println!("=== LibMainWorkerFactory.create_main_worker() Example ===");
  println!();
  println!("This example demonstrates calling create_main_worker()!");
  println!();
...
"#;
  ...
  println!();
  println!("NOW CALLING create_main_worker()...");
