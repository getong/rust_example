...
const opSetResult = core.ops.libmainworker_embed_set_result;
const opSetExitData = core.ops.libmainworker_embed_set_exit_data;
  ...
  globalThis.embedDeno = {
    setResult(value) {
      if (typeof opSetResult !== "function") {
        throw new TypeError(
          "embedDeno.setResult op is not available (core.ops.libmainworker_embed_set_result)",
        );
      }
    ...
    setExitData(value) {
      if (typeof opSetExitData !== "function") {
        throw new TypeError(
          "embedDeno.setExitData op is not available (core.ops.libmainworker_embed_set_exit_data)",
        );
      }
