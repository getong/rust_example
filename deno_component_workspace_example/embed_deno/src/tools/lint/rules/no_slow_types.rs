...
use deno_ast::{ModuleSpecifier, diagnostics::Diagnostic};
use deno_graph::{ModuleGraph, fast_check::FastCheckDiagnostic};
use deno_lint::{
  diagnostic::{LintDiagnostic, LintDiagnosticDetails, LintDiagnosticRange, LintDocsUrl},
  tags,
};
