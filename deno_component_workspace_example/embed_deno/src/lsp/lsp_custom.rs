...
impl lsp::notification::Notification for DidRefreshDenoConfigurationTreeNotification {
...
impl lsp::notification::Notification for DidChangeDenoConfigurationNotification {
