...
impl TscConstants {
  pub fn new() -> Self {
    Self {
      ...
      ignored_diagnostic_codes: super::IGNORED_DIAGNOSTIC_CODES.iter().copied().collect(),
    }
  }
}
...
mod tests {
  ...
  use super::{
    super::{Diagnostic, DiagnosticCategory},
    *,
  };
  use crate::{
    args::CompilerOptions,
    tsc::{MISSING_DEPENDENCY_SPECIFIER, get_lazily_loaded_asset},
  };
