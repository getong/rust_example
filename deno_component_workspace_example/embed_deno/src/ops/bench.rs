...
use deno_runtime::{
  deno_permissions::{ChildPermissionsArg, PermissionsContainer},
  deno_web::StartTime,
};
use tokio::sync::mpsc::UnboundedSender;
use uuid::Uuid;

use crate::tools::bench::{BenchDescription, BenchEvent};

#[derive(Default)]
pub(crate) struct BenchContainer(pub Vec<(BenchDescription, v8::Global<v8::Function>)>);
