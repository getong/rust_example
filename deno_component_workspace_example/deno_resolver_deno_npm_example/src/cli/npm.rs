...
use crate::cli::version::DENO_VERSION_INFO;
...
use crate::cli::file_fetcher::CliFileFetcher;
use crate::cli::http_util::HttpClientProvider;
use crate::cli::CliSys;
use crate::cli::task_runner::TaskStdio;
use crate::cli::util::progress_bar::ProgressBar;
use crate::cli::util::progress_bar::ProgressMessagePrompt;
  ...
  async fn download_with_retries_on_any_tokio_runtime(
    ...
    client
      ...
      .map(|response| match response {
        crate::cli::http_util::HttpClientResponse::Success { headers, body } => {
        ...
        crate::cli::http_util::HttpClientResponse::NotFound => {
          NpmCacheHttpClientResponse::NotFound
        }
        crate::cli::http_util::HttpClientResponse::NotModified => {
          NpmCacheHttpClientResponse::NotModified
        }
      })
      .map_err(|err| {
        use crate::cli::http_util::DownloadErrorKind::*;
...
impl LifecycleScriptsExecutor for DenoTaskLifeCycleScriptsExecutor {
  async fn execute(
    ...
    let mut env_vars = crate::cli::task_runner::real_env_vars();
      ...
      for script_name in ["preinstall", "install", "postinstall"] {
        if let Some(script) = scripts.get(script_name) {
          ...
          let pb = ProgressBar::new(
            crate::cli::util::progress_bar::ProgressBarStyle::TextOnly,
          );
          let _guard = pb.update_with_prompt(
            ProgressMessagePrompt::Initialize,
            &format!("{}: running '{script_name}' script", package.id.nv),
          );
          let crate::cli::task_runner::TaskResult {
            exit_code,
            stderr,
            stdout,
          } =
            crate::cli::task_runner::run_task(crate::cli::task_runner::RunTaskOptions {
              ...
              stdio: Some(crate::cli::task_runner::TaskIo {
...
impl DenoTaskLifeCycleScriptsExecutor {
  ...
  ) -> crate::cli::task_runner::TaskCustomCommands {
    let mut custom_commands = crate::cli::task_runner::TaskCustomCommands::new();
    custom_commands
      .insert("npx".to_string(), Rc::new(crate::cli::task_runner::NpxCommand));

    custom_commands
      .insert("npm".to_string(), Rc::new(crate::cli::task_runner::NpmCommand));

    custom_commands
      .insert("node".to_string(), Rc::new(crate::cli::task_runner::NodeCommand));

    custom_commands.insert(
      "node-gyp".to_string(),
      Rc::new(crate::cli::task_runner::NodeGypCommand),
    );
  ...
  >(
    ...
    extra_info_provider: &CachedNpmPackageExtraInfoProvider,
    bin_entries: &mut BinEntries<'a, CliSys>,
    mut commands: crate::cli::task_runner::TaskCustomCommands,
    snapshot: &'a NpmResolutionSnapshot,
    packages: P,
  ) -> crate::cli::task_runner::TaskCustomCommands {
    ...
    for (bin_name, script_path) in bins {
      commands.insert(
        bin_name.clone(),
        Rc::new(crate::cli::task_runner::NodeModulesFileRunCommand {
  ...
  async fn resolve_custom_commands_from_deps(
    &self,
    extra_info_provider: &CachedNpmPackageExtraInfoProvider,
    baseline: crate::cli::task_runner::TaskCustomCommands,
