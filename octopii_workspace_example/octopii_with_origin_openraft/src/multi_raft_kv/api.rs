...
use super::{NodeId, TypeConfig, app::GroupApp, decode, encode, typ::*};
...
pub async fn transfer_leader(app: &mut GroupApp, req: String) -> String {
  let transfer_req: TransferLeaderRequest<TypeConfig> = decode(&req);
  let res: Result<TransferLeaderResponse<TypeConfig>, RaftError> = app
    .raft
