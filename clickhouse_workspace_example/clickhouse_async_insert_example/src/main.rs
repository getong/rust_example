...
// This example demonstrates how to use asynchronous inserts, avoiding client side batching of the
// incoming data. Suitable for ClickHouse Cloud, too. See https://clickhouse.com/docs/en/optimize/asynchronous-inserts
...
async fn main() -> Result<()> {
  ...
  // Start an async insert; await the future before writing rows
