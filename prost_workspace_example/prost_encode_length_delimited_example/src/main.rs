...
fn main() {
  ...
  // size:24
  // encode_length_delimited_to_vec:[24, 10, 22, 82, 101, 99, 101, 105, 118, 101, 100, 32, 121, 111,
  // 117, 114, 32, 109, 101, 115, 115, 97, 103, 101, 33] encode_to_vec:[10, 22, 82, 101, 99, 101,
  // 105, 118, 101, 100, 32, 121, 111, 117, 114, 32, 109, 101, 115, 115, 97, 103, 101, 33]
  // buf:[10, 22, 82, 101, 99, 101, 105, 118, 101, 100, 32, 121, 111, 117, 114, 32, 109, 101, 115,
  // 115, 97, 103, 101, 33]
}
