...
fn main() {
  ...
  let u256 = u256_hex(
    &U256::from_dec_str(
      "115569590093573465686975422602080333992787915355521131868309842096538601843211",
    )
    .unwrap(),
  );
  ...
  println!(
    "u256 is {:#?}",
    hex::decode("115569590093573465686975422602080333992787915355521131868309842096538601843211")
  );

  // 4bd6dacf2d5a5c93f410964569cddab068bb038ce976e53818cc032181cb8373
  let new_u256 = u256_hex(&U256::from(
    "4bd6dacf2d5a5c93f410964569cddab068bb038ce976e53818cc032181cb8373",
  ));
