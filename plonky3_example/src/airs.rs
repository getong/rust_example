use p3_air::{Air, AirBuilder, BaseAir, DebugConstraintBuilder, symbolic::SymbolicAirBuilder};
...
{
  fn generate_trace_rows(&self, num_hashes: usize, extra_capacity_bits: usize) -> RowMajorMatrix<F>
  where
