  ...
  match option_registration_request {
    ...
    Some(registration_request) => {
      match valid_registration_data_user(
        ...
        TypeValidDataFromRegistration::Ok => RegistrationRequestError::Ok(registration_request),
        TypeValidDataFromRegistration::BadFirstName => RegistrationRequestError::BadFirstName,
