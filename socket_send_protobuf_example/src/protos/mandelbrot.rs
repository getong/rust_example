...
//! Generated file from `mandelbrot.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_3_0;

// @@protoc_insertion_point(message:mandelbrot.StateSignal)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct StateSignal {
    // message fields
    // @@protoc_insertion_point(field:mandelbrot.StateSignal.id)
    pub id: i32,
    // @@protoc_insertion_point(field:mandelbrot.StateSignal.current_scale)
    pub current_scale: f64,
    // special fields
    // @@protoc_insertion_point(special_field:mandelbrot.StateSignal.special_fields)
...
impl StateSignal {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &StateSignal| { &m.id },
            |m: &mut StateSignal| { &mut m.id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "current_scale",
            |m: &StateSignal| { &m.current_scale },
            |m: &mut StateSignal| { &mut m.current_scale },
        ));
...
impl ::protobuf::Message for StateSignal {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                17 => {
                    self.current_scale = is.read_double()?;
                },
                tag => {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.current_scale != 0. {
            os.write_double(2, self.current_scale)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x10mandelbrot.proto\x12\nmandelbrot\"B\n\x0bStateSignal\x12\x0e\n\x02\
    id\x18\x01\x20\x01(\x05R\x02id\x12#\n\rcurrent_scale\x18\x02\x20\x01(\
    \x01R\x0ccurrentScaleb\x06proto3\
";
