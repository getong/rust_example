...
//     // Hexadecimal string to byte array conversion
//     let hex_string =
// ""
// ;

//     // Convert hex string to byte vector
//     let byte_data: Vec<u8> = Vec::from_hex(hex_string).expect("Failed to decode hex string");

//     // Convert byte vector to ethers::types::Bytes
//     let byte = Bytes::from(byte_data);

//     // Decode bytes into ChannelOpen event
//     let event = ChannelOpen::decode_log(&byte).expect("Failed to decode event");
...
//   // Extract the string and convert to U256
//   let total_str = deserialized.get("total").expect("Key 'total' not found");
//   let total_value = U256::from_dec_str(total_str).expect("Failed to parse decimal string to
// U256");
